...
export default function EditAlerteModal({ item, onClose, onSubmit }) {
  const [nbSms, setNbSms] = useState(item.nbSms);
  const [notifySms, setNotifySms] = useState(item.notifySms);
  const [phone, setPhone] = useState(item.phone || "");
  const [notifyEmail, setNotifyEmail] = useState(item.notifyEmail);
